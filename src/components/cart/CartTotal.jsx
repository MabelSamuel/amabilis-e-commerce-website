...
const CartTotal = ({getTotalPriceOfCart}) => {
  return (
    <div className='border w-1/3 px-8 py-10 bg-gray-200 rounded-md md:w-full sm:w-full sm:text-sm sm:px-4'>
        ...
        <button className='uppercase bg-lilac w-full rounded-full py-4 text-white font-medium hover:bg-black'>Proceed to checkout</button>
    </div>
  )
}
